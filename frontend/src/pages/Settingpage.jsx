...
function SettingsPage() {
  ...
  const handleHealthCheck = async () => {
    ...
    try {
      ...
      setHealthData({ status: "error", database: "disconnected" })
    } finally {
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-3 gap-3">
                ...
                <button
                  ...
                  className={`p-5 bg-bg-card border-2 rounded-3xl flex flex-col items-center gap-2.5 cursor-pointer transition-all relative ${theme === "light"
                ...
                <button
                  ...
                  className={`p-5 bg-bg-card border-2 rounded-3xl flex flex-col items-center gap-2.5 cursor-pointer transition-all relative ${theme === "dark"
                    ? "border-accent ring-2 ring-accent/20"
                    : "border-border-app hover:border-gray-300 dark:hover:border-gray-700"
                    }`}
                >
                ...
                <button
                  ...
                  className={`p-5 bg-bg-card border-2 rounded-3xl flex flex-col items-center gap-2.5 cursor-pointer transition-all relative ${theme === "system"
                    ? "border-accent ring-2 ring-accent/20"
                    : "border-border-app hover:border-gray-300 dark:hover:border-gray-700"
                    }`}
                >
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                {PRESET_THEMES.map((t) => (
                  <button
                    ...
                    className={`group flex flex-col items-center gap-2 p-3 rounded-3xl border-2 transition-all cursor-pointer ${presetTheme === t.id
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-5 gap-4">
                ...
                <button
                  ...
                  className={`aspect-[3/4] rounded-3xl border flex flex-col items-center justify-center bg-bg-card cursor-pointer transition-all relative overflow-hidden ${chatWallpaper === "none" ? "border-accent ring-2 ring-accent/20" : "border-border-app hover:border-gray-300 dark:hover:border-gray-700"
                    }`}
                >
                ...
                <button
                  ...
                  className={`aspect-[3/4] rounded-3xl border cursor-pointer transition-all relative overflow-hidden bg-gradient-to-tr from-orange-100 to-rose-100 dark:from-orange-950/20 dark:to-rose-950/20 ${chatWallpaper === "sunset" ? "border-accent ring-2 ring-accent/20" : "border-border-app hover:border-gray-300 dark:hover:border-gray-700"
                    }`}
                >
                ...
                <button
                  ...
                  className={`aspect-[3/4] rounded-3xl border cursor-pointer transition-all relative overflow-hidden bg-gradient-to-tr from-sky-100 to-indigo-100 dark:from-sky-950/20 dark:to-indigo-950/20 ${chatWallpaper === "ocean" ? "border-accent ring-2 ring-accent/20" : "border-border-app hover:border-gray-300 dark:hover:border-gray-700"
                    }`}
                >
                ...
                <button
                  ...
                  className={`aspect-[3/4] rounded-3xl border cursor-pointer transition-all relative overflow-hidden bg-gradient-to-tr from-emerald-50 to-teal-50 dark:from-emerald-950/10 dark:to-teal-950/10 ${chatWallpaper === "forest" ? "border-accent ring-2 ring-accent/20" : "border-border-app hover:border-gray-300 dark:hover:border-gray-700"
                    }`}
                >
                ...
                <button
                  ...
                  className={`aspect-[3/4] rounded-3xl border cursor-pointer bg-cover bg-center transition-all relative overflow-hidden ${chatWallpaper === "mountain" ? "border-accent ring-2 ring-accent/20" : "border-border-app hover:border-gray-300 dark:hover:border-gray-700"
                    }`}
                >
          ...
          <div className="space-y-6 animate-slide-in text-left">
            ...
            <div className="bg-bg-card border border-border-app rounded-3xl p-6 space-y-6 shadow-sm">
              ...
              <div className="bg-bg-card border border-border-app rounded-3xl p-6 text-left space-y-4 shadow-sm">
                <div className="flex items-center justify-between">
                  <div>
                    <h3 className="text-sm font-bold text-text-title">System Health</h3>
                    <p className="text-xs text-text-body opacity-60">Check live status of the backend API and database connection.</p>
                  </div>
                  <button
                    onClick={handleHealthCheck}
                    disabled={healthLoading}
                    className="bg-accent hover:bg-accent/90 text-white font-extrabold px-5 py-2.5 rounded-full text-xs tracking-wide transition-all cursor-pointer disabled:opacity-50"
                  >
                ...
                {healthData && (
                  <div className="mt-3 p-4 bg-bg-app border border-border-app rounded-2xl text-xs space-y-1">
                    <p className="text-text-title font-medium">
                      Status: <span className={healthData.status === 'ok' ? 'text-green-500 font-bold' : 'text-red-500 font-bold'}>{healthData.status}</span>
                    </p>
                    <p className="text-text-title font-medium">
                      Database: <span className="text-blue-500 font-bold">{healthData.database}</span>
                    </p>
                    {healthData.uptimeSeconds !== undefined && (
                      <p className="text-text-body opacity-70">Uptime: {healthData.uptimeSeconds} seconds</p>
                    )}
                    {healthData.timestamp && (
                      <p className="text-text-body opacity-50 text-[10px]">Checked at: {healthData.timestamp}</p>
                    )}
                  </div>
                )}
              </div>
